    ...
    return (
      <>
        ...
        <div className=" flex flex-col p-2 mb-2 text-center w-2/5 items-center mx-auto">
          <span
            className="text-gray-600 py-4 px-64 whitespace-nowrap rounded
           font-extrabold text-3xl my-8"
          >
            Кошик порожній...
          </span>
          <Link
            className="text-white text-4xl font-bold rounded py-6 px-6 bg-orange-500"
            href="/catalog"
          >
            Перейти до покупок
          </Link>
  ...
  return (
    <>
      ...
      <div className="p-2 mb-2 relative">
        ...
        <div className="flex">
          <p className="text-orange-500 font-extrabold text-3xl my-4 ms-auto">
            Загальна Сума:{" "}
            <span className="text-slate-900 font-bold">{totalPrice} $</span>
            <Link
              className="text-white rounded m-24 mt-12 py-2 px-3 bg-orange-500"
              href="/payment"
            >
              Перейти до оплати
            </Link>
            <Link
              className="text-white text-3xl font-bold rounded my-4 py-2 px-2 bg-gray-400"
              href="/catalog"
            >
              Назад до покупок
            </Link>
